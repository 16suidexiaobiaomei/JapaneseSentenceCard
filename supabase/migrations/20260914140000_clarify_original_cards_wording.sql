-- The 50-card minimum only ever counted "original" cards (source_shared_tag_id
-- is null) — downloaded cards were always excluded — but the error text just
-- said "50 cards", which reads as "any 50 cards" for a tag that mixes
-- originals with downloaded ones. Wording-only change, no logic change.
